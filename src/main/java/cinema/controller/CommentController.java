...
public class CommentController {
    ...
    public CommentController(CommentService commentService, MovieService movieService, UserService userService, ResponseDtoMapper<CommentResponseDto, Comment> mapper) {
    ...
    public CommentResponseDto add(@PathVariable Long movieId, @RequestBody String text) {
        ...
        comment.setUser(userService.findByEmail(username).orElseThrow(
                () -> new RuntimeException("Unknown user writes comment")));
